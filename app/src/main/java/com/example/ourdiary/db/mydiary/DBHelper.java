package com.example.ourdiary.db.mydiary;
...
import com.example.ourdiary.entries.diary.item.IDairyRow;

import static com.example.ourdiary.db.mydiary.DBStructure.ContactsEntry;
import static com.example.ourdiary.db.mydiary.DBStructure.DiaryEntry;
import static com.example.ourdiary.db.mydiary.DBStructure.DiaryEntry_V2;
import static com.example.ourdiary.db.mydiary.DBStructure.DiaryItemEntry_V2;
import static com.example.ourdiary.db.mydiary.DBStructure.MemoEntry;
import static com.example.ourdiary.db.mydiary.DBStructure.MemoOrderEntry;
import static com.example.ourdiary.db.mydiary.DBStructure.TopicEntry;
import static com.example.ourdiary.db.mydiary.DBStructure.TopicOrderEntry;

public class DBHelper extends SQLiteOpenHelper {
    public static final int DATABASE_VERSION = 7;
    public static final String DATABASE_NAME = "new_our_diary.db";
